...
export default function CoordinatorTicketsPage() {
  ...
  const getStatusText = (ticket: Ticket) => {
    if (ticket.status === "in_progress") {
      return "Coordinator started working on ticket"
    }
      ...
      <main className="min-h-screen bg-muted">
        <div className="container py-12">
           ...
           <div className="mb-8">
             ...
             <p className="text-muted-foreground">Manage and track your assigned tickets from Social Media Coordinator</p>
             <div className="mt-4">
               <Link to="/coordinator/dashboard" className="btn-outline">
                 ← Back to Dashboard
               </Link>
             </div>
           </div>

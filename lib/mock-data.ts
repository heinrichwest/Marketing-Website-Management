...
export const mockProjects: Project[] = [
   {
     ...
     googleAnalyticsPropertyId: "414990159",
  ...
  },
  {
   ...
   {
     id: "proj-27",
     name: "November Marketing Campaign",
     description: "Comprehensive marketing campaign for November product launches",
     projectType: "social_media",
     clientId: "user-5",
     socialMediaCoordinatorId: "user-4",
     currentStage: "launch",
     ...
     campaignGoals: "Drive 500 website visits, increase newsletter signups by 200",
     targetAudience: "Existing customers and prospects in November promotions",
   ...
   },
   {
     ...
     description: "Holiday season social media campaign and website updates",
     projectType: "social_media",
     clientId: "user-6",
     socialMediaCoordinatorId: "user-4",
     currentStage: "maintenance",
     ...
     campaignGoals: "Increase engagement by 150%, drive holiday sales by 25%",
     targetAudience: "Holiday shoppers and brand followers",
     createdAt: new Date("2024-12-01"),
   ...
   {
     id: "proj-29",
     name: "End of Year Review Portal",
     description: "Interactive portal for year-end performance reviews and planning",
     projectType: "website",
     clientId: "user-5",
     webDeveloperId: "user-3",
     currentStage: "testing",
     status: "active",
     websiteUrl: "https://speccon.co.za/year-review",
     googleAnalyticsPropertyId: "414990158",
     googleAnalyticsViewId: "987654320",
     createdAt: new Date("2024-12-10"),

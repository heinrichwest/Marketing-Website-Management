...
export async function createFirebaseProject(
  ...
  try {
    ...
    const projectData = {
      ...
      googleAnalyticsPropertyId: data.googleAnalyticsPropertyId || null,
      googleAnalyticsViewId: data.googleAnalyticsViewId || null,
    ...
    if (!createdSnapshot.empty) {
      ...
      const project: Project = {
        ...
        googleAnalyticsPropertyId: docData.googleAnalyticsPropertyId,
        googleAnalyticsViewId: docData.googleAnalyticsViewId,
